module ApplicationHelper
  ...
  def small_profile_img(user)
    ...
    content = "<div class='profile-img' style='#{'background: black;' if user.profile_img.url != nil}'>"+image_tag(user.profile_img.url, style: "width:#{finalWidth}px;height:#{finalHeight}px;margin-left:#{finalOffsetX}px;margin-top:#{finalOffsetY}px;", class: "#{'display-none' if user.profile_img.url == nil}")+"</div>"
    content.html_safe
  end
end

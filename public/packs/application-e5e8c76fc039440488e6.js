...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_create_emotion__ = __webpack_require__(/*! create-emotion */ 35);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! ./../../webpack/buildin/global.js */ 17)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fbjs_lib_shallowEqual__ = __webpack_require__(/*! fbjs/lib/shallowEqual */ 11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hoist_non_react_statics__ = __webpack_require__(/*! hoist-non-react-statics */ 38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_hoist_non_react_statics___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_hoist_non_react_statics__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(/*! change-emitter */ 39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(/*! symbol-observable */ 40);
...
/* 14 */
/*!*************************************************!*\
  !*** ./app/javascript/components/Collection.js ***!
  \*************************************************/
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_react_spinners__ = __webpack_require__(/*! react-spinners */ 32);
...
var Collection = function (_React$Component) {
  ...
  function Collection(props) {
    ...
    Object.defineProperty(_this, "newSearch", {
      enumerable: true,
      writable: true,
      value: function value() {}
    });
    Object.defineProperty(_this, "handleSearchFormChange", {
      enumerable: true,
      writable: true,
  ...
  _createClass(Collection, [{
    ...
    value: function componentDidMount() {
      ...
      $.get(this.props.rootUrl + "collection_api?" + queryString).then(function (data) {
        var users = [];
        var photos = [];
        var locations = [];
        var filteredArray = [];
        var collectionLength = data.length;
        if (_this2.props.limit != undefined && _this2.props.limit < data.length) {
          collectionLength = _this2.props.limit;
        }
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[1].email.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[2].title.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1;
      });
      var fUsers = [];
      var fPhotos = [];
      var fLocations = [];
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        this.props.search && this.state.users.length > 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(SearchBar, { val: this.state.searchQuery, newSearch: this.newSearch, update: this.handleSearchFormChange }),
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          null,
          this.state.users.length > 0 && !this.props.search && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Grid, { photos: this.state.photos, users: this.state.users, locations: this.state.locations, rootUrl: this.props.rootUrl, currentUser: this.props.currentUser, colls: this.state.colls, limit: this.props.limit, loading: this.state.loading }),
          this.props.search && filtered.length > 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Grid, { photos: fPhotos, users: fUsers, locations: fLocations, rootUrl: this.props.rootUrl, currentUser: this.props.currentUser, colls: this.state.colls, limit: this.props.limit, loading: this.state.loading })
        )
      );
    }
  }]);
...
var Grid = function Grid(props) {
  ...
  var photoGrid = photoArray.map(function (photo, i) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "div",
      { key: photo.id, className: parseDigitToString(props.colls) + " columns img-card img-card-" + 12 / props.colls },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: "img-holder img-holder-" + 12 / props.colls },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: photo.img_url.url })
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "p",
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(UserTag, { profile_img: props.users[i].profile_img, width: props.users[i].width, height: props.users[i].height, zoom: props.users[i].zoom, offsetX: props.users[i].offsetX, offsetY: props.users[i].offsetY, rootUrl: props.rootUrl, id: props.users[i].id, email: props.users[i].email }),
        " \"",
        photo.caption,
        "\" ",
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "a",
          { href: props.rootUrl + "location/" + props.locations[i].id, className: "img-card-link", "data-turbolinks": "false" },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: "https://s3-us-west-2.amazonaws.com/staticgeofocus/70+by+70.png", style: { width: 20, height: 20, display: 'inline' } }),
          props.locations[i].title
        ),
        " ",
        props.currentUser != null && props.currentUser.verified && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "a",
          { href: props.rootUrl + "report/new?photo" + photo.id, className: "img-card-link" },
          "Report Content"
        )
      ),
      props.currentUser != null && (props.currentUser.id == props.users[i].id || props.currentUser.role == 'admin') && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "a",
        { href: props.rootUrl + "photo/" + photo.id, "data-method": "delete", "data-turbolinks": "true", className: "button delete-button" },
        "Delete"
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "a",
        { href: props.rootUrl + "photo/" + photo.id, className: "button" },
        "View - ",
        photo.views,
        " Views"
      )
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "div",
    { className: "row" },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2_react_spinners__["RingLoader"], {
      color: '#123abc',
...
var UserTag = function UserTag(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "a",
    { href: props.rootUrl + "user/show/" + props.id, className: "img-card-link", "data-turbolinks": "false" },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ProfileImg, { scaleRatio: 0.0625, profile_img: props.profile_img, userWidth: props.width, userHeight: props.height, zoom: props.zoom, offsetX: props.offsetX, offsetY: props.offsetY }),
    props.email
  );
};
var ProfileImg = function ProfileImg(props) {
  var displayWidth = props.scaleRatio * 400;
  var image = "";
  if (props.profile_img.url != undefined) {
    console.log(props);
    var finalWidth = props.scaleRatio * props.userWidth * parseFloat(props.zoom);
    var finalHeight = props.scaleRatio * props.userHeight * parseFloat(props.zoom);
    var finalOffsetX = props.offsetX * props.scaleRatio;
    var finalOffsetY = props.offsetY * props.scaleRatio;
    image = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: props.profile_img.url, style: { width: finalWidth, height: finalHeight, marginLeft: finalOffsetX, marginTop: finalOffsetY } });
  }
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "span",
    { className: "profile-img", style: { background: "black", width: displayWidth, height: displayWidth } },
    image
  );
};
var SearchBar = function SearchBar(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: props.val, onChange: props.update, placeholder: "\uF002 Search", style: { fontFamily: "Helvetica ,FontAwesome" } })
  );
};
...
Collection.propTypes = {
  ...
  rootUrl: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
  ...
  collumns: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.number,
  search: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool
};
...
/*!**********************************************!*\
  ...
  \**********************************************/
/*! dynamic exports provided */
/*! exports used: RingLoader */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! ./dist/index */ 33);
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(/*! ./spinners/BarLoader */ 34), __webpack_require__(/*! ./spinners/BeatLoader */ 43), __webpack_require__(/*! ./spinners/BounceLoader */ 44), __webpack_require__(/*! ./spinners/CircleLoader */ 45), __webpack_require__(/*! ./spinners/ClipLoader */ 46), __webpack_require__(/*! ./spinners/ClimbingBoxLoader */ 47), __webpack_require__(/*! ./spinners/DotLoader */ 48), __webpack_require__(/*! ./spinners/FadeLoader */ 49), __webpack_require__(/*! ./spinners/GridLoader */ 50), __webpack_require__(/*! ./spinners/HashLoader */ 60), __webpack_require__(/*! ./spinners/MoonLoader */ 51), __webpack_require__(/*! ./spinners/PacmanLoader */ 52), __webpack_require__(/*! ./spinners/PropagateLoader */ 53), __webpack_require__(/*! ./spinners/PulseLoader */ 54), __webpack_require__(/*! ./spinners/RingLoader */ 55), __webpack_require__(/*! ./spinners/RiseLoader */ 56), __webpack_require__(/*! ./spinners/RotateLoader */ 57), __webpack_require__(/*! ./spinners/ScaleLoader */ 58), __webpack_require__(/*! ./spinners/SyncLoader */ 59)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! react */ 0), __webpack_require__(/*! prop-types */ 1), __webpack_require__(/*! emotion */ 2), __webpack_require__(/*! recompose */ 3), __webpack_require__(/*! ../helpers */ 18)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_emotion_utils__ = __webpack_require__(/*! emotion-utils */ 36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_stylis_rule_sheet__ = __webpack_require__(/*! stylis-rule-sheet */ 37);
...
/*!*****************************************************!*\
  ...
  \*****************************************************/
/*! exports provided: memoize, STYLES_KEY, unitless, hashString, Stylis */
/*! exports used: STYLES_KEY, Stylis, hashString, memoize, unitless */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ponyfill_js__ = __webpack_require__(/*! ./ponyfill.js */ 42);
/* global window */
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! ./../../webpack/buildin/global.js */ 17), __webpack_require__(/*! ./../../webpack/buildin/harmony-module.js */ 41)(module)))
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! react */ 0), __webpack_require__(/*! prop-types */ 1), __webpack_require__(/*! emotion */ 2), __webpack_require__(/*! recompose */ 3)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else if (typeof exports !== "undefined") {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        ...
        return (0, _emotion.css)('composes:', _this.style(1), ';top:', _this.radius, 'px;left:0;');
      }, _this.b = function () {
        return (0, _emotion.css)('composes:', _this.style(2), ';top:', _this.quarter, 'px;left:', _this.quarter, 'px;transform:rotate(-45deg);');
      }, _this.c = function () {
        return (0, _emotion.css)('composes:', _this.style(3), ';top:0;left:', _this.radius, 'px;transform:rotate(90deg);');
      }, _this.d = function () {
        return (0, _emotion.css)('composes:', _this.style(4), ';top:', -_this.quarter, 'px;left:', _this.quarter, 'px;transform:rotate(45deg);');
      }, _this.e = function () {
        return (0, _emotion.css)('composes:', _this.style(5), ';top:', -_this.radius, 'px;left:0;');
      }, _this.f = function () {
        return (0, _emotion.css)('composes:', _this.style(6), ';top:', -_this.quarter, 'px;left:', -_this.quarter, 'px;transform:rotate(-45deg);');
      }, _this.g = function () {
        return (0, _emotion.css)('composes:', _this.style(7), ';top:0;left:', -_this.radius, 'px;transform:rotate(90deg);');
      }, _this.h = function () {
        return (0, _emotion.css)('composes:', _this.style(8), ';top:', _this.quarter, 'px;left:', -_this.quarter, 'px;transform:rotate(45deg);');
      }, _temp), _possibleConstructorReturn(_this, _ret);
    }
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.moonSize = function () {
        ...
        return (0, _emotion.css)('composes:', _this.ballStyle(_this.moonSize()), ';background-color:', _this.props.color, ';opacity:0.8;position:absolute;top:', (_this.props.size / 2 - _this.moonSize() / 2).toString() + _this.props.sizeUnit, ';animation:', moon, ' 0.6s 0s infinite linear;animation-fill-mode:forwards;');
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  var Loader = function (_React$Component) {
    ...
    function Loader() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Loader.__proto__ || Object.getPrototypeOf(Loader)).call.apply(_ref, [this].concat(args))), _this), _this.style = function (i) {
        return (0, _emotion.css)('{background-color:', _this.props.color, ';width:', _this.props.size + _this.props.sizeUnit, '\n        height:', _this.props.size + _this.props.sizeUnit, '\n        margin:', _this.props.margin, ';border-radius:100%;display:inline-block;animation:', sync, ' 0.6s ', i * 0.07, 's infinite ease-in-out;animation-fill-mode:both;}');
      }, _temp), _possibleConstructorReturn(_this, _ret);
    }
...
var ReactDOMServer = __webpack_require__(/*! react-dom/server */ 62)

var detectEvents = __webpack_require__(/*! ./src/events/detect */ 65)
var constructorFromGlobal = __webpack_require__(/*! ./src/getConstructor/fromGlobal */ 30)
var constructorFromRequireContextWithGlobalFallback = __webpack_require__(/*! ./src/getConstructor/fromRequireContextWithGlobalFallback */ 71)
...
if (false) {
  ...
  module.exports = __webpack_require__(/*! ./cjs/react-dom-server.browser.development.js */ 63);
}
...
var emptyObject = __webpack_require__(/*! fbjs/lib/emptyObject */ 9);
var hyphenateStyleName = __webpack_require__(/*! fbjs/lib/hyphenateStyleName */ 12);
var memoizeStringOnly = __webpack_require__(/*! fbjs/lib/memoizeStringOnly */ 64);
var warning = __webpack_require__(/*! fbjs/lib/warning */ 6);
var checkPropTypes = __webpack_require__(/*! prop-types/checkPropTypes */ 8);
var camelizeStyleName = __webpack_require__(/*! fbjs/lib/camelizeStyleName */ 13);
...
var nativeEvents = __webpack_require__(/*! ./native */ 66)
var pjaxEvents = __webpack_require__(/*! ./pjax */ 67)
var turbolinksEvents = __webpack_require__(/*! ./turbolinks */ 68)
var turbolinksClassicDeprecatedEvents = __webpack_require__(/*! ./turbolinksClassicDeprecated */ 69)
var turbolinksClassicEvents = __webpack_require__(/*! ./turbolinksClassic */ 70)
...
var fromGlobal = __webpack_require__(/*! ./fromGlobal */ 30)
var fromRequireContext = __webpack_require__(/*! ./fromRequireContext */ 72)
...
console.log('Hello World This is Miguel.');
// Support component names relative to this directory:
var componentRequireContext = __webpack_require__(/*! components */ 31);
var ReactRailsUJS = __webpack_require__(/*! react_ujs */ 61);
ReactRailsUJS.useContext(componentRequireContext);
window.componentRequireContext = componentRequireContext;

/***/ })
/******/ ]);
//# sourceMappingURL=application-e5e8c76fc039440488e6.js.map
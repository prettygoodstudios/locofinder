...
var ProfileImg = function ProfileImg(props) {
  var width = props.scaleRatio * 400;
  var image = "";
  if (props.profile_img.url != nil) {
    var finalWidth = props.scaleRatio * props.userWidth * props.zoom;
    var finalHeight = props.scaleRatio * props.userHeight * props.zoom;
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "div",
    { "class": "profile-img", style: ({ background: "black" }, { width: width }, { height: width }) },
    image
  );
};
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-b720347458ef5ccd4941.js.map
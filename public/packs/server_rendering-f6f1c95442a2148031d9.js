...
var Grid = function Grid(props) {
  ...
  var photoGrid = photoArray.map(function (photo, i) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(UserTag, { profile_img: props.users[i].profile_img, width: props.users[i].width, height: props.users[i].height, zoom: props.users[i].zoom, offsetX: props.users[i].offsetX, offsetY: props.users[i].offsetY, rootUrl: props.rootUrl })
    );
  });
  console.log(photoArray);
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
var UserTag = function UserTag(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "a",
    { href: _this3.props.rootUrl + _this3.props.id },
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-f6f1c95442a2148031d9.js.map
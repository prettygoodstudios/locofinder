...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_lazyload__ = __webpack_require__(/*! react-lazyload */ 14);
...
var Collection = function (_React$Component) {
  ...
  function Collection(props) {
    ...
    Object.defineProperty(_this, "sortByPoints", {
      enumerable: true,
      writable: true,
      value: function value(arr, searchQuery) {
        var retVal = arr.sort(function (a, b) {
  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[1].email.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[2].title.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || (photo[2].city + " " + photo[2].state + " " + photo[2].country + " ").toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1;
      });
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          this.state.users.length > 0 && !this.props.search && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Grid, { photos: this.state.photos, users: this.state.users, locations: this.state.locations, rootUrl: this.props.rootUrl, currentUser: this.props.currentUser, colls: this.state.colls, limit: this.props.limit }),
          this.props.search && filtered.length > 0 && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Grid, { photos: fPhotos, users: fUsers, locations: fLocations, rootUrl: this.props.rootUrl, currentUser: this.props.currentUser, colls: this.state.colls, limit: this.props.limit, style: { marginTop: this.state.loading ? "700px" : "0px" } })
        )
      );
    }
  }]);
...
var Grid = function Grid(props) {
  ...
  var placeholderDiv = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { key: Math.floor(Math.random() * 500000), className: parseDigitToString(props.colls) + " columns img-card img-card-" + 12 / props.colls });
  var photoGrid = photoArray.map(function (photo, i) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      __WEBPACK_IMPORTED_MODULE_1_react_lazyload___default.a,
      { offset: 100, placeholder: placeholderDiv },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          photo.zoom == null && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: photo.img_url.url }),
          photo.zoom != null && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Photo, { url: photo.img_url.url, width: photo.width, height: photo.height, zoom: photo.zoom, offsetX: photo.offsetX, offsetY: photo.offsetY, colls: props.colls })
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("br", null),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "p",
          null,
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(UserTag, { profileImg: props.users[i].profile_img, width: props.users[i].width, height: props.users[i].height, zoom: props.users[i].zoom, offsetX: props.users[i].offsetX, offsetY: props.users[i].offsetY, rootUrl: props.rootUrl, id: props.users[i].slug, display: props.users[i].display }),
          " ",
          photo.caption ? "\"" + photo.caption + "\"" : "",
          " ",
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "a",
            { href: props.rootUrl + "location/" + props.locations[i].slug, className: "img-card-link", "data-turbolinks": "false" },
        ...
        props.currentUser != null && (props.currentUser.id == props.users[i].id || props.currentUser.role == 'admin') && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "a",
          { href: props.rootUrl + "photo/" + photo.slug, "data-method": "delete", "data-turbolinks": "true", className: "button delete-button" },
          "Delete"
        ),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "a",
          { href: props.rootUrl + "photo/" + photo.slug, className: "button" },
          "View - ",
          photo.views,
          " Views"
        )
...
var Photo = function (_React$Component2) {
  ...
  function Photo(props) {
    ...
    var _this4 = _possibleConstructorReturn(this, (Photo.__proto__ || Object.getPrototypeOf(Photo)).call(this, props));
  ...
  _createClass(Photo, [{
    ...
    value: function componentDidMount() {
      ...
      window.addEventListener("resize", function () {
        return _this5.updateDimensions();
      });
    }
  }, {
    key: "render",
    value: function render() {
      var _state = this.state,
          ...
          finalOffsetX = _state.finalOffsetX,
          finalOffsetY = _state.finalOffsetY;
      var props = this.props;

      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { style: { width: finalWidth, height: finalHeight, marginLeft: finalOffsetX, marginTop: finalOffsetY }, src: props.url });
    }
  }]);
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "updateDimensions", {
    enumerable: true,
    writable: true,
    value: function value() {
      var props = _this6.props;
      var colls = 12 / props.colls;
      ...
      var totWidth = window.innerWidth * 0.85;
      ...
      var diff = totWidth - (finalWidth - Math.abs(finalOffsetX));
      if (diff > 0) {
        //finalOffsetX +=  totWidth - (finalWidth - finalOffsetX);
        var scaleY = 250 / (finalHeight - Math.abs(finalOffsetY));
        var scaleX = totWidth / (finalWidth - Math.abs(finalOffsetX));
        var scaleUp = scaleY > scaleX ? scaleY : scaleX;
...
var UserTag = function UserTag(_ref) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    "a",
    { href: rootUrl + "user/show/" + id, className: "img-card-link", "data-turbolinks": "false" },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(ProfileImg, { scaleRatio: 0.0625, profile_img: profileImg, userWidth: width, userHeight: height, zoom: zoom, offsetX: offsetX, offsetY: offsetY }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      "span",
...
var SearchBar = function SearchBar(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: props.val, onChange: props.update, placeholder: "\uF002 Search", style: { fontFamily: "Avenir Heavy ,FontAwesome" } })
  );
};
...
Collection.propTypes = {
  ...
  user: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  location: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  rootUrl: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
  currentUser: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.object,
  limit: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number,
  collumns: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.number,
  search: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.bool
};
...
var _event = __webpack_require__(/*! ./utils/event */ 31);

var _scrollParent = __webpack_require__(/*! ./utils/scrollParent */ 32);

var _scrollParent2 = _interopRequireDefault(_scrollParent);

var _debounce = __webpack_require__(/*! ./utils/debounce */ 33);

var _debounce2 = _interopRequireDefault(_debounce);

var _throttle = __webpack_require__(/*! ./utils/throttle */ 34);

var _throttle2 = _interopRequireDefault(_throttle);

var _decorator = __webpack_require__(/*! ./decorator */ 35);
...
/* 27 */
/*!*****************************************************!*\
  !*** ./app/javascript/components/LocationSearch.js ***!
  \*****************************************************/
/*! exports provided: default */
/*! all exports used */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var LocationSearch = function (_React$Component) {
  ...
  function LocationSearch(props) {
    ...
    Object.defineProperty(_this, "sortByPoints", {
      enumerable: true,
      writable: true,
      value: function value(arr, sQ) {
        var retVal = arr.sort(function (a, b) {
          var pointsB = 0;
          var pointsA = 0;
          var termMatchesA = 0;
          var termMatchesB = 0;
          sQ.split(" ").forEach(function (searchQ) {
            var searchQuery = searchQ.trim();
            if (searchQuery != "") {
              ...
              a.title.toLowerCase().split(" ").forEach(function (t) {
                var tA = t.trim();
                if (tA == searchQuery) {
                  termMatchesA++;
                }
              });
              a.address.toLowerCase().split(" ").forEach(function (a) {
                var aA = a.trim();
                if (aA == searchQuery) {
                  termMatchesA++;
                }
              ...
              b.title.toLowerCase().split(" ").forEach(function (t) {
                var tB = t.trim();
                if (tB == searchQuery) {
                  termMatchesB++;
                }
              });
              b.address.toLowerCase().split(" ").forEach(function (a) {
                var aB = a.trim();
                if (aB == searchQuery) {
                  termMatchesB++;
                }
    ...
    Object.defineProperty(_this, "subQuery", {
      enumerable: true,
      writable: true,
      value: function value(sQ, location) {
  ...
  _createClass(LocationSearch, [{
    ...
    value: function componentDidMount() {
      ...
      $.get(this.props.rootUrl + "geo_json_api").then(function (data) {
        var locos = [];
    ...
    value: function render() {
      ...
      var results = filtered.map(function (location) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "a",
          { href: _this3.props.rootUrl + "location/" + location.slug, className: "location-search-result", "data-turbolinks": "false" },
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            "h3",
            null,
            location.title
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: searchQuery, onChange: this.handleSearchFormChange, placeholder: "\uF002 Search", style: { fontFamily: "Avenir Heavy ,FontAwesome" } }),
        searchQuery != "" && results
      );
    }
  }]);
...
var _index = __webpack_require__(/*! ./index */ 14);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-f6730bdbd52a2a717033.js.map
  ...
  _createClass(LocationSearch, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.locations.filter(function (location) {
        return location.address.indexOf(_this2.state.searchQuery.toLowerCase()) !== -1 || location.title.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1;
      });
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-000b2d2fe704683a5769.js.map
    ...
    Object.defineProperty(_this, "sortByPoints", {
      ...
      value: function value(arr) {
        var retVal = arr.sort(function (a, b) {
          console.log(a.title);
          var titleA = a.title.toLowerCase().indexOf(state.searchQuery.toLowerCase()) !== -1;
          var addressA = a.address.toLowerCase().indexOf(state.searchQuery.toLowerCase()) !== -1;
          var pointsA = 0;
          if (titleA) {
            pointsA += 2;
          }
          ...
          console.log(pointsA);
          var titleB = b.title.toLowerCase().indexOf(state.searchQuery.toLowerCase()) !== -1;
          var addressB = b.address.toLowerCase().indexOf(state.searchQuery.toLowerCase()) !== -1;
          var pointsB = 0;
          if (titleB) {
            pointsB += 2;
          }
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-9a8c76fb2715089e3fd2.js.map
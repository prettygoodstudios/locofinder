  ...
  _createClass(LocationSearch, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.locations.filter(function (location) {
        return location.address.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1 || location.title.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1;
      });
      var results = this.state.locations.map(function (location) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          "div",
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              "a",
              { href: _this2.props.rootUrl + "location/" + location.id },
              location.title
            )
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-1a07431400ff52e9b8f8.js.map
  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1 || photo[1].email.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1 || photo[2].title.toLowerCase().indexOf(_this2.state.searchQuery.toLowerCase()) !== -1;
      });
      var fUsers = [];
      var fPhotos = [];
      var fLocations = [];
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-01f0dd0a9ed5060565bf.js.map
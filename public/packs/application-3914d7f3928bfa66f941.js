  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[1].email.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[2].title.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[2].address.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1;
      });
      var fUsers = [];
      var fPhotos = [];
      var fLocations = [];
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-3914d7f3928bfa66f941.js.map
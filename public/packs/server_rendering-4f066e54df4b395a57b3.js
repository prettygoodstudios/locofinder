  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.indexOf(_this3.state.searchQuery) !== -1 || photo[1].email.indexOf(_this3.state.searchQuery) !== -1;
      });
      var fUsers = [];
      var fPhotos = [];
      var fLocations = [];
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-4f066e54df4b395a57b3.js.map
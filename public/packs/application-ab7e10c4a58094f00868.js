    ...
    Object.defineProperty(_this, "sortByPoints", {
      ...
      value: function value(arr) {
        var retVal = arr.sort(function (a, b) {
          console.log(a);
          var titleA = a[2].title.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var addressA = a[2].address.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var pointsA = 0;
          if (titleA) {
            pointsA += 2;
          }
          ...
          var titleB = b[2].title.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var addressB = b[2].address.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var pointsB = 0;
          if (titleB) {
            pointsB += 2;
          }
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-ab7e10c4a58094f00868.js.map
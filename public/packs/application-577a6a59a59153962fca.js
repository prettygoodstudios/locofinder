...
var Grid = function Grid(props) {
  ...
  var first6 = photoGrid.slice(0, 6);
  var photoSections = [];
  var remainingPhotos = photoGrid.length - 6;
  for (var i = 0; i < Math.ceil(remainingPhotos / 3); i++) {
    var photoSection = photoGrid.slice(i * 3 + 6, i * 3 + 9);
    photoSections.push(photoSection);
  }
  console.log(photoArray);
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      first6,
      photoSections.map(function (ps, i) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_1_react_lazyload___default.a,
          { offset: 100, key: i },
          ps
...
var Photo = function (_React$Component2) {
  ...
  function Photo(props) {
    ...
    _this4.updateDimensions().bind(_this4);
    return _this4;
  }
  ...
  _createClass(LocationSearch, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.locations.filter(function (location) {
        return location.address.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || location.title.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1;
      });
      filtered = this.sortByPoints(filtered, this.state.searchQuery);
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("input", { type: "text", value: this.state.searchQuery, onChange: this.handleSearchFormChange, placeholder: "\uF002 Search", style: { fontFamily: "Helvetica ,FontAwesome" } }),
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-577a6a59a59153962fca.js.map
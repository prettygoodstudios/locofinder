...
throw new Error("Module build failed: SyntaxError: Unexpected token, expected , (61:87)\n\n  59 |         <UserTag profile_img={props.users[i].profile_img} width={props.users[i].width} height={props.users[i].height} zoom={props.users[i].zoom} offsetX={props.users[i].offsetX} offsetY={props.users[i].offsetY} rootUrl={props.rootUrl} id={props.users[i].id} email={props.users[i].email} /> \"{photo.caption}\" <a href={props.rootUrl+\"location/\"+props.locations[i].id} className=\"img-card-link\"><img src=\"https://s3-us-west-2.amazonaws.com/staticgeofocus/70+by+70.png\" style={{width: 20, height: 20, display: 'inline'}} />{props.locations[i].title}</a> { props.currentUser != undefined && <a href={props.rootUrl+\"report/new?photo\"+photo.id} className=\"img-card-link\">Report Content</a> }\n  60 |       </p>\n> 61 |       { ((props.currentUser.id != null || props.currentUser.role == 'admin') && { props.currentUser.id == props.users[i].id && <a href={props.rootUrl+\"photo/\"+photo.id} method=\"delete\" className=\"button delete-button\">Delete</a>}}\n     |                                                                                        ^\n  62 |       <a href={props.rootUrl+\"photo/\"+photo.id} className=\"button\">View - {photo.views} Views</a>\n  63 |     </div>\n  64 |   );\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-088eb191101006b917be.js.map
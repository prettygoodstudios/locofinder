...
throw new Error("Module build failed: SyntaxError: Unexpected token (61:6)\n\n  59 |         <UserTag profile_img={props.users[i].profile_img} width={props.users[i].width} height={props.users[i].height} zoom={props.users[i].zoom} offsetX={props.users[i].offsetX} offsetY={props.users[i].offsetY} rootUrl={props.rootUrl} id={props.users[i].id} email={props.users[i].email} />\n  60 |          \"{photo.caption}\" <a href={props.rootUrl+\"location/show/\"+props.locations[i].id}\n> 61 |       </p>\n     |       ^\n  62 |     </div>\n  63 |   );\n  64 |   console.log(photoArray);\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-af6429fd205be779eb1c.js.map
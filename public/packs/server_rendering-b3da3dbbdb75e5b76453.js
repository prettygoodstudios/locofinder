  ...
  _createClass(Collection, [{
    ...
    value: function render() {
      ...
      var filtered = this.state.filteredArray.filter(function (photo) {
        return photo[0].caption.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1 || photo[1].email.toLowerCase().indexOf(_this3.state.searchQuery.toLowerCase()) !== -1;
      });
      var fUsers = [];
      var fPhotos = [];
      var fLocations = [];
...
/***/ })
/******/ ]);
//# sourceMappingURL=server_rendering-b3da3dbbdb75e5b76453.js.map
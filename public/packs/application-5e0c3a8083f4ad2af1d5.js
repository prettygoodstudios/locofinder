...
throw new Error("Module build failed: SyntaxError: Unsyntactic continue (38:10)\n\n  36 |         const searchQuery = searchQ.trim();\n  37 |         if(searchQuery == \"\"){\n> 38 |           continue;\n     |           ^\n  39 |         }\n  40 |         var titleA = a.title.toLowerCase().indexOf(searchQuery.toLowerCase()) !== -1;\n  41 |         var addressA = a.address.toLowerCase().indexOf(searchQuery.toLowerCase()) !== -1;\n");
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-5e0c3a8083f4ad2af1d5.js.map
  ...
  var photoGrid = photoArray.map(function (photo, i) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        photo.zoom == null && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { src: photo.img_url.url, style: { maxWidth: "200%" } }),
...
var LocationSearch = function (_React$Component) {
  ...
  function LocationSearch(props) {
    ...
    Object.defineProperty(_this, "sortByPoints", {
      ...
      value: function value(arr) {
        var retVal = arr.sort(function (a, b) {
          console.log(a.title);
          var titleA = a.title.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var addressA = a.address.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var pointsA = 0;
          if (titleA) {
            pointsA += 2;
          }
          ...
          console.log(pointsA);
          var titleB = b.title.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var addressB = b.address.toLowerCase().indexOf(this.state.searchQuery.toLowerCase()) !== -1;
          var pointsB = 0;
          if (titleB) {
            pointsB += 2;
          }
    ...
    _this.sortByPoints = _this.sortByPoints.bind(_this);
    return _this;
  }
  ...
  _createClass(LocationSearch, [{
    ...
    value: function render() {
      ...
      filtered = this.sortByPoints(filtered);
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-7f73dadaec4d3e29832e.js.map
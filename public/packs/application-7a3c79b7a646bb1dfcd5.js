  ...
  function LocationSearch(props) {
    ...
    Object.defineProperty(_this, "sortByPoints", {
      ...
      value: function value(arr, sQ) {
        var retVal = arr.sort(function (a, b) {
          var pointsB = 0;
          var pointsA = 0;
          sQ.split(" ").forEach(function (searchQuery) {
    ...
    Object.defineProperty(_this, "subQuery", {
      ...
      value: function value(sQ, location) {
        return location.address.toLowerCase().indexOf(sQ.toLowerCase().trim()) !== -1 || location.title.toLowerCase().indexOf(sQ.toLowerCase().trim()) !== -1;
      }
    });
...
/***/ })
/******/ ]);
//# sourceMappingURL=application-7a3c79b7a646bb1dfcd5.js.map